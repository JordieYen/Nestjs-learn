  ...
  describe('Bookmarks', () => {
    ...
    describe('Create bookmark', ()=> {
      const dto: CreateBookmarkDto = {
        ...
        link: 'https://www.youtube.com/watch?v=GHTA143_b-s&t=2707s'
      }
      ...
      it('should create bookmark', () => {
        ...
        .withBody(dto)
        .expectStatus(201).inspect().stores('bookmarkId', 'id');
      });
    });
    ...
    describe('Get bookmark by id', ()=> {
      it('should get bookmark by id', () => {
        return pactum
        .spec()
        .get('/bookmarks/{id}').withPathParams('id', '$S{bookmarkId}')
        .withHeaders({
          Authorization: 'Bearer $S{userAt}'
    ...
    describe('Edit bookmark by id', ()=> {
      ...
      it('should edit bookmark', () => {
        return pactum
        .spec()
        .patch('/bookmarks/{id}').withPathParams('id', '$S{bookmarkId}')
        .withHeaders({
          Authorization: 'Bearer $S{userAt}'
        }).withBody(dto)
        .expectStatus(200)
    ...
    describe('delete bookmark by id', ()=> {
      it('should delete bookmark', () => {
        return pactum
        .spec()
        .delete('/bookmarks/{id}').withPathParams('id', '$S{bookmarkId}')
        .withHeaders({
          Authorization: 'Bearer $S{userAt}'
        })
        .expectStatus(204);
