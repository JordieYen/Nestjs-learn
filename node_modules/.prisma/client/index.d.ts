...
export namespace Prisma {
  ...
  /**
   * Prisma Client JS version: 4.15.0-dev.16
   * Query Engine version: 5d720aff70d72bd85e9d322b854f025c99f6419b
   */
  ...
  */
  ...
  export type BookmarkGetPayload<S extends boolean | null | undefined | BookmarkArgs> =
    ...
    : S extends { select: any } & (BookmarkArgs | BookmarkFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> | null :  P extends keyof Bookmark ? Bookmark[P] : never
  } 
      : Bookmark
